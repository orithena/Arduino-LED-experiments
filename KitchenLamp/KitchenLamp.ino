...
void setup_ui() {
  ...
  ESPUI.slider("Bottom <--> Top", &slider_callback, COLOR_EMERALD, String(_max(0, _min(100, state.ratio * 100) )));
...
const double f = 0.033;

int sinematrix3() {
  EVERY_N_MILLISECONDS( 70 ) {
  pangle = addmodpi( pangle, (0.00133 + (angle/256)) * f );
  angle = cos(pangle) * PI;
